      ...
      <div className=" bg-yellow-400 h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
        ...
        <div className=" flex items-center justify-center gap-8 ">
          ...
          <a
            ...
            href="https://api.whatsapp.com/send/?phone=9579703839&text&type=phone_number&app_absent=0"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
          ...
          <a
            ...
            href="https://www.instagram.com/vedantj727/"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
